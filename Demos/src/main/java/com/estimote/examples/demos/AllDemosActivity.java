...
public class AllDemosActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.characteristics_demo_button).setOnClickListener(new View.OnClickListener() {
      ...
      findViewById(R.id.test_demo_button).setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View v) {
              Intent intent = new Intent(AllDemosActivity.this, ListBeaconsActivity.class);
              intent.putExtra(ListBeaconsActivity.EXTRAS_TARGET_ACTIVITY, Test.class.getName());
              startActivity(intent);
          }
      });

      findViewById(R.id.asdf_demo_button).setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View v) {
              Intent intent = new Intent(AllDemosActivity.this, ListBeacons.class);
              startActivity(intent);
          }
      });
  }
